							...
							<div class="row form-group">
								...
								<div class="col-md-8"> 
									<div class="input-group">
										...
										<input type="text" value="FULLNAME" class="form-control" id="name" > 
							...
							<div class="row form-group">
								...
								<div class="col-md-8"> 
									<div class="input-group">
										...
										<input type="month" value="" class="form-control" id="year"> 
							...
							<div class="row form-group">
								...
								<div class="col-md-8"> 
									<div class="input-group">
										...
										<input type="number" value="" class="form-control" id="mob" max="9999999999" placeholder="Mobile Number"> 
							...
							<div class="row form-group">
								...
								<div class="col-md-8"> 
									<div class="input-group">
										...
										<input type="number" placeholder="Emergency Number" class="form-control" id="emergency" max="9999999999"> 
